        ...
        <table class="uk-table uk-table-striped uk-table-hover uk-table-small">
            ...
            <tr>
                <th class="uk-table-shrink uk-text-center">
					<?php echo HTMLHelper::_('searchtools.sort', 'COM_UMART_CODE', 'a.order_code', $listDirn, $listOrder); ?>
                </th>
                <th class="uk-table-shrink uk-text-nowrap uk-text-center">
					<?php echo HTMLHelper::_('searchtools.sort', 'COM_UMART_ORDER_STATUS', 'a.state', $listDirn, $listOrder); ?>
                </th>
                <th class="uk-table-shrink uk-text-nowrap uk-text-center">
					<?php echo HTMLHelper::_('searchtools.sort', 'COM_UMART_TOTAL_PRICE', 'a.total_price', $listDirn, $listOrder); ?>
                </th>
                <th class="uk-visible@m">
					<?php echo HTMLHelper::_('searchtools.sort', 'COM_UMART_CREATED_DATE', 'a.created_date', $listDirn, $listOrder); ?>
                </th>
                <th>
			...
			<?php foreach ($this->orders as $i => $order):
                ...
                <tr>
                    <td class="uk-text-center">
						...
						<?php else: ?>
                            <a href="<?php echo Route::_('index.php?option=com_umart&task=customer.page&page=order&orderId=' . $order->id . '&return=' . $return, false); ?>"
                               class="es-order-code">
								<?php echo $this->escape($order->order_code); ?>
                            </a>
						<?php endif; ?>
