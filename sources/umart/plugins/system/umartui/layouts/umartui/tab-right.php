...
?>
<div class="umartui-tab tab-right">
    <div class="uk-grid-small" uk-grid>
        <div class="umartui_width-auto@m uk-flex-last@m">
            <ul class="uk-tab-right" uk-tab="connect: #<?php echo $switcherId; ?>">
				<?php echo $tabsTitle; ?>
            </ul>
        </div>
        <div class="umartui_width-expand@m">
