...
class User
{
	...
	public function can($core, $asset = 'com_umart')
	{
		return $this->core($core, $asset);
	}

	public function core($core, $asset = 'com_umart', $stateOverride = true)
	{
		if ($stateOverride)
		{
			$stateCore = plg_sytem_umart_main('state')->get('user.core.' . $asset . '.' . str_replace('.', '_', $core));
	...
	public function getAvatar()
	{
		...
		{
			return UMART_MEDIA_URL . '/images/no-avatar.jpg';
		}

		return UMART_MEDIA_URL . '/' . $this->avatar;
	}
