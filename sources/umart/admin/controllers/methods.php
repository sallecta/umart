...
class EasyshopControllerMethods extends AdminController
{
	...
	public function __construct(array $config)
	{
		...
		{
			throw new Exception(JText::_('COM_EASYSHOP_ERROR_INVALID_METHOD'));
		}
	...
	protected function getMethod()
	{
		...
		{
			throw new RuntimeException(JText::sprintf('COM_EASYSHOP_ERROR_METHOD_ID_NOT_FOUND', $methodId), 404);
		}
	...
	public function setDefault()
	{
		...
		$table   = JTable::getInstance('Method', 'EasyshopTable');
		$pk      = (int) @$pks[0];
		...
		$this->setRedirect(JRoute::_('index.php?option=com_easyshop&view=' . $this->view_list . $this->getRedirectToListAppend(), false), $message, $type);
	}
}
