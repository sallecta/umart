...
<table class="uk-table uk-table-small uk-table-divider uk-table-hover es-order-notification">
    ...
    <tr>
        <th class="uk-table-shrink uk-text-center uk-text-nowrap">
			<?php echo Text::_('COM_EASYSHOP_CODE'); ?>
        </th>
        <th class="uk-table-shrink uk-text-center uk-text-nowrap">
			<?php echo Text::_('COM_EASYSHOP_ORDER_STATUS'); ?>
        </th>
        <th class="uk-table-shrink uk-text-center uk-text-nowrap">
			<?php echo Text::_('COM_EASYSHOP_PRICE'); ?>
        </th>
        <th>
			<?php echo Text::_('COM_EASYSHOP_DATE'); ?>
        </th>
        <th class="uk-visible@m">
			<?php echo Text::_('COM_EASYSHOP_BILLING_SHIPPING_INFO') ?>
        </th>
    </tr>
    </thead>
    <tbody>
		...
		<?php foreach ($displayData['orders'] as $order):
            ...
            <tr>
                <td class="uk-text-center uk-text-nowrap">
                    <a href="<?php echo Route::_('index.php?option=com_easyshop&task=order.edit&id=' . $order->id, false); ?>"
                       class="es-order-code">
