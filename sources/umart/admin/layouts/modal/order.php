...
$count            = count($orders);
$iframeAttributes = [
	'src'    => JRoute::_('index.php?option=com_easyshop&view=orders&layout=modal&tmpl=component', false),
	'width'  => '100%',
	'height' => '450',
...
<div class="uk-scope">
	<?php if ($multiple): ?>
        ...
        <div class="uk-placeholder uk-margin uk-padding-small uk-width-medium">
