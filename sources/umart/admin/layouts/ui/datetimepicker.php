...
extract($displayData);
?>
<div class="uk-scope es-scope es-field-datetime-picker-container">
                ...
                <ul class="uk-iconnav uk-position-small uk-position-top-right">
                    <li<?php echo $inline ? ' hidden' : ''; ?>>
                        <a href="#" uk-icon="icon: check" class="es-icon-check"
                           title="<?php echo Text::_('COM_EASYSHOP_SELECT_N_CLOSE'); ?>" uk-tooltip></a>
                    </li>
                    <li>
                        <a href="#" uk-icon="icon: refresh" class="es-icon-refresh"
                           title="<?php echo Text::_('COM_EASYSHOP_CLEAR'); ?>" uk-tooltip></a>
                    </li>
                    <li<?php echo $inline ? ' hidden' : ''; ?>>
                        <a href="#" uk-icon="icon: close" class="es-icon-close"
                           title="<?php echo Text::_('COM_EASYSHOP_CLOSE'); ?>" uk-tooltip></a>
                    </li>
                </ul>
                <div class="uk-text-center uk-margin es-date-display">
					<?php echo $valueFormat ?: Text::_('COM_EASYSHOP_NO_DATETIME_SELECTED'); ?>
                </div>
