...
<tr>
    ...
    <th>
		<?php echo HTMLHelper::_('searchtools.sort', 'COM_EASYSHOP_NAME', 'a.name_english', $vars['listDirn'], $vars['listOrder']); ?>
    </th>
    <th class="uk-table-shrink uk-text-center uk-text-nowrap uk-visible@m">
		<?php echo HTMLHelper::_('searchtools.sort', 'COM_EASYSHOP_CODE_2', 'a.code_2', $vars['listDirn'],
			$vars['listOrder']); ?>
    </th>
    <th class="uk-table-shrink uk-text-center uk-text-nowrap uk-visible@m">
		<?php echo HTMLHelper::_('searchtools.sort', 'COM_EASYSHOP_CODE_3', 'a.code_3', $vars['listDirn'],
			$vars['listOrder']); ?>
    </th>
    <th class="uk-table-shrink uk-text-center uk-text-nowrap">
		<?php echo HTMLHelper::_('searchtools.sort', 'COM_EASYSHOP_TYPE', 'a.type', $vars['listDirn'],
			$vars['listOrder']); ?>
    </th>
    <th class="uk-table-shrink uk-text-center uk-text-nowrap uk-visible@m">
...
<?php foreach ($this->items as $i => $item):
    ...
    <tr>
        ...
        <td class="uk-text-center uk-text-nowrap uk-visible@m">
			<?php echo Text::_('COM_EASYSHOP_' . strtoupper($this->escape($item->type))); ?>
        </td>
        <td class="uk-text-center uk-text-nowrap uk-visible@m">
			<?php echo $item->id; ?>
        </td>
