...
<tr>
    ...
    <th class="uk-table-shrink uk-text-nowrap uk-text-center uk-visible@m">
		<?php echo HTMLHelper::_('searchtools.sort', 'COM_UMART_TYPE', 'a.type', $vars['listDirn'], $vars['listOrder']); ?>
    </th>
    <th class="uk-table-shrink uk-text-nowrap uk-text-center">
		<?php echo HTMLHelper::_('searchtools.sort', 'COM_UMART_CODE', 'a.coupon_code', $vars['listDirn'],
			$vars['listOrder']); ?>
    </th>
    <th class="uk-table-shrink uk-text-nowrap uk-text-center">
		<?php echo HTMLHelper::_('searchtools.sort', 'COM_UMART_FLAT_AMOUNT', 'a.flat', $vars['listDirn'], $vars['listOrder']); ?>
    </th>
    <th class="uk-table-shrink uk-text-nowrap uk-text-center uk-visible@m">
		<?php echo HTMLHelper::_('searchtools.sort', 'COM_UMART_PERCENTAGE_AMOUNT', 'a.percentage', $vars['listDirn'], $vars['listOrder']); ?>
    </th>
    <th class="uk-table-shrink uk-text-nowrap uk-text-center uk-visible@m">
		<?php echo HTMLHelper::_('searchtools.sort', 'COM_UMART_START_DATE', 'a.start_date', $vars['listDirn'], $vars['listOrder']); ?>
    </th>
    <th class="uk-table-shrink uk-text-nowrap uk-text-center uk-visible@m">
		<?php echo HTMLHelper::_('searchtools.sort', 'COM_UMART_END_DATE', 'a.end_date', $vars['listDirn'],
			$vars['listOrder']); ?>
    </th>
    <th class="uk-table-shrink uk-text-nowrap uk-text-center uk-visible@m">
...
<?php foreach ($this->items as $i => $item):
    ...
    <tr>
        ...
        <td class="uk-text-center uk-text-nowrap uk-visible@m">
			...
			{
				case 0:
					echo Text::_('COM_UMART_ON_PRODUCTS');
					break;
				case 1:
					echo Text::_('COM_UMART_ON_COUPON');
					break;
				case 2:
					echo Text::_('COM_UMART_ON_ORDER');
					break;
			} ?>
        </td>
        <td class="uk-text-center uk-text-nowrap">
