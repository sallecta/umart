...
<tr>
	...
	<?php if ($reflector == 'com_umart.user'): ?>
        <th class="uk-table-shrink uk-text-center uk-text-nowrap">
			<?php echo HTMLHelper::_('searchtools.sort', 'COM_UMART_CHECKOUT_FIELD', 'a.checkout_field', $vars['listDirn'], $vars['listOrder']); ?>
        </th>
	<?php else: ?>
        <th class="uk-table-shrink uk-text-center uk-text-nowrap">
			<?php echo HTMLHelper::_('searchtools.sort', 'COM_UMART_GROUP', 'group_title', $vars['listDirn'], $vars['listOrder']); ?>
        </th>
	<?php endif; ?>
    <th class="uk-table-shrink uk-text-center uk-text-nowrap">
    ...
    <tr>
        ...
        <td class="uk-text-center uk-text-nowrap">
			<?php if ($item->protected): ?>
                <a class="uk-button uk-button-default uk-button-small"
                   uk-tooltip
                   uk-icon="icon: lock"
                   title="<?php echo Text::_('COM_UMART_FIELD_BE_PROTECTED'); ?>">
                </a>
			<?php else: ?>
        ...
        <td>
			<?php if ($coreEdit || $coreEditOwn) : ?>
                <a href="<?php echo Route::_('index.php?option=com_umart&task=customfield.edit&id=' . $item->id . '&reflector=' . $reflector, false); ?>"
		...
		<?php if ($reflector == 'com_umart.user'): ?>
            <td class="uk-text-center uk-text-nowrap">
                <a href="<?php echo Route::_('index.php?option=com_umart&task=customfield.checkoutField&reflector=' . $reflector . '&id=' . $item->id . '&' . JSession::getFormToken() . '=1', false); ?>"
