...
$method        = Text::_('COM_UMART_' . strtoupper($type) . '_METHOD');
...
<tr>
    ...
    <th class="uk-table-shrink uk-text-center uk-text-nowrap">
		<?php echo HTMLHelper::_('searchtools.sort', 'COM_UMART_DEFAULT', 'a.is_default', $vars['listDirn'], $vars['listOrder']); ?>
    </th>
    <th class="uk-table-shrink uk-text-center uk-text-nowrap uk-visible@m">
		<?php echo HTMLHelper::_('searchtools.sort', 'COM_UMART_TYPE', 'e.folder', $vars['listDirn'], $vars['listOrder']); ?>
    </th>
	<?php if ($language): ?>
        <th class="uk-table-shrink uk-text-center uk-text-nowrap uk-visible@m">
			<?php echo HTMLHelper::_('searchtools.sort', 'COM_UMART_LANGUAGE', 'a.language', $vars['listDirn'], $vars['listOrder']); ?>
        </th>
	<?php endif; ?>
    <th class="uk-table-shrink uk-text-center uk-text-nowrap uk-visible@m">
    ...
    <tr>
        ...
        <td>
			<?php if ($coreEdit || $coreEditOwn) : ?>
                <a href="<?php echo Route::_('index.php?option=com_umart&task=method.edit&filter_type=' . $type . '&method_id=' . $item->method_id . '&id=' . $item->id, false); ?>"
        ...
        <td class="uk-text-nowrap uk-text-center">
			...
			<?php else: ?>
                <a
                        ...
                        title="" data-original-title="<?php echo Text::_('COM_UMART_SET_AS_DEFAULT'); ?>">
