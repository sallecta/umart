...
<tr>
    ...
    <th class="uk-table-shrink uk-text-center uk-text-nowrap">
		<?php echo HTMLHelper::_('searchtools.sort', 'COM_UMART_CODE', 'a.code', $vars['listDirn'], $vars['listOrder']); ?>
    </th>
    <th class="uk-table-shrink uk-text-center uk-text-nowrap">
		<?php echo HTMLHelper::_('searchtools.sort', 'COM_UMART_SYMBOL', 'a.symbol', $vars['listDirn'], $vars['listOrder']); ?>
    </th>
    <th class="uk-table-shrink uk-text-center uk-text-nowrap uk-visible@m">
		<?php echo HTMLHelper::_('searchtools.sort', 'COM_UMART_RATE', 'a.rate', $vars['listDirn'], $vars['listOrder']); ?>
    </th>
    <th class="uk-table-shrink uk-text-center uk-text-nowrap uk-visible@m">
        ...
        <td class="uk-text-nowrap uk-text-center">
			...
			<?php else: ?>
                <a class="uk-button uk-button-small"
                   ...
                   title="" data-original-title="<?php echo JText::_('COM_UMART_SET_AS_DEFAULT'); ?>">
                    <class uk-icon="icon: star"></class>
                </a>
			<?php endif; ?>
        </td>
