...
class UmartModelUsers extends ListModel
{
	...
	protected function getListQuery()
	{
		...
		$query->from($db->quoteName('#__umart_users', 'a'));
		$subQuery = $db->getQuery(true)
			->select('COUNT(*)')
			->from($db->quoteName('#__umart_orders', 'a2'))
	...
	public function getFilterForm($data = [], $loadData = true)
	{
		...
		{
			$filterVendor = plg_sytem_umart_main('app')->input->get('filter_vendor', null);
