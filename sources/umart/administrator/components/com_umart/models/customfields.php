...
class UmartModelCustomfields extends ListModel
{
	...
	{
		$reflector = plg_sytem_umart_main('app')->input->getCmd('reflector', 'com_umart');
	...
	protected function getListQuery()
	{
		...
		$query->from($db->quoteName('#__umart_customfields', 'a'));
	...
	public function getFilterForm($data = [], $loadData = true)
	{
		...
		if (strpos($reflector, 'com_umart.product') !== 0)
		{
