...
<script>
    ...
    var salesData = {
        ...
        datasets: [
            {
                label: '<?php echo Text::_('COM_UMART_PAYMENT_PAID'); ?>',
            ...
            {
                label: '<?php echo Text::_('COM_UMART_PAYMENT_UNPAID'); ?>',
            ...
            {
                label: '<?php echo Text::_('COM_UMART_PAYMENT_REFUND'); ?>',
    ...
    if (_umart.getData('chart', false) === false) {
        _umart.setData('chart', new Chart(document.getElementById('es-sales-data').getContext('2d')));
    }
                ...
                yAxes: [
                    {
                        ticks: {
                            callback: function (value, index, values) {
                                return _umart.currencyFormat(value, currency);
                            }
                        }
                    }
                ]
            ...
            tooltips: {
                callbacks: {
                    label: function (tooltipItem, data) {
                        return _umart.currencyFormat(tooltipItem.yLabel, currency);
                    }
                }
            }
        }
