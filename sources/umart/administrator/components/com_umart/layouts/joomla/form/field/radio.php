...
$class  = str_replace('uk-radio', '', $class);
$class  = str_replace('radio', '', $class);
$class  = preg_replace('/\s+/', ' ', $class);
?>
<fieldset id="<?php echo $id; ?>"
          class="<?php echo trim($class . ' uk-fieldset field-radio' . ($readonly || $disabled ? ' disabled' : '') . ($readonly ? ' readonly' : '')); ?>"
	...
	<?php if (!empty($options)) : ?>
		<?php foreach ($options as $i => $option) : ?>
			...
			$option->class = 'uk-radio' . (!empty($option->class) ? ' ' . $option->class : '');
