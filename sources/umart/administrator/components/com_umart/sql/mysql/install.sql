CREATE TABLE IF NOT EXISTS `#__umart_currencies`
(
...
--
-- Table structure for table `#__umart_customfields`
--

CREATE TABLE IF NOT EXISTS `#__umart_customfields`
(
    `id`               INT(10) UNSIGNED    NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `#__umart_customfield_values`
--

CREATE TABLE IF NOT EXISTS `#__umart_customfield_values`
(
...
--
-- Table structure for table `#__umart_discounts`
--

CREATE TABLE IF NOT EXISTS `#__umart_discounts`
(
    `id`                     INT(10) UNSIGNED        NOT NULL AUTO_INCREMENT,
    `name`                   VARCHAR(255)            NOT NULL DEFAULT '',
    `state`                  TINYINT(1)              NOT NULL DEFAULT '1',
...
--
-- Table structure for table `#__umart_emails`
--

CREATE TABLE IF NOT EXISTS `#__umart_emails`
(
    `id`               INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
    `name`             VARCHAR(255)     NOT NULL DEFAULT '',
    `state`            TINYINT(1)       NOT NULL DEFAULT '1',
...
--
-- Table structure for table `#__umart_logs`
--

CREATE TABLE IF NOT EXISTS `#__umart_logs`
(
...
--
-- Table structure for table `#__umart_medias`
--

CREATE TABLE IF NOT EXISTS `#__umart_medias`
(
    `id`               BIGINT(20) UNSIGNED NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `#__umart_orders`
--

CREATE TABLE IF NOT EXISTS `#__umart_orders`
(
    `id`               INT(10) UNSIGNED        NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `#__umart_order_products`
--

CREATE TABLE IF NOT EXISTS `#__umart_order_products`
(
    `id`                    INT(10) UNSIGNED        NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `#__umart_order_product_options`
--

CREATE TABLE IF NOT EXISTS `#__umart_order_product_options`
(
    `id`               INT(10) UNSIGNED        NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `#__umart_order_coupons`
--

CREATE TABLE IF NOT EXISTS `#__umart_order_coupons`
(
...
--
-- Table structure for table `#__umart_methods`
--

CREATE TABLE IF NOT EXISTS `#__umart_methods`
(
    `id`               INT(10) UNSIGNED        NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `#__umart_prices`
--

CREATE TABLE IF NOT EXISTS `#__umart_prices`
(
...
--
-- Table structure for table `#__umart_price_days`
--

CREATE TABLE IF NOT EXISTS `#__umart_price_days`
(
    `product_id` INT(10) UNSIGNED        NOT NULL,
...
--
-- Table structure for table `#__umart_products`
--

CREATE TABLE IF NOT EXISTS `#__umart_products`
(
    `id`                INT(10) UNSIGNED        NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `#__umart_taxes`
--

CREATE TABLE IF NOT EXISTS `#__umart_taxes`
(
    `id`               INT(10) UNSIGNED        NOT NULL AUTO_INCREMENT,
    `name`             VARCHAR(255)            NOT NULL DEFAULT '',
...
--
-- Table structure for table `#__umart_users`
--

CREATE TABLE IF NOT EXISTS `#__umart_users`
(
    `id`               INT(10) UNSIGNED    NOT NULL AUTO_INCREMENT,
    `user_id`          INT(10) UNSIGNED    NOT NULL DEFAULT '0',
...
--
-- Table structure for table `#__umart_zones`
--

CREATE TABLE IF NOT EXISTS `#__umart_zones`
(
    `id`               INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
    `parent_id`        INT(10) UNSIGNED NOT NULL DEFAULT '0',
    `name`             VARCHAR(255)     NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `#__umart_params`
(
...
CREATE TABLE IF NOT EXISTS `#__umart_tags`
(
    `id`               INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
    `context`          VARCHAR(255)     NOT NULL DEFAULT '',
    `name`             VARCHAR(255)     NOT NULL DEFAULT '',
...
-- ----------------------------
-- Table structure for `#__umart_tag_items`
-- ----------------------------

CREATE TABLE IF NOT EXISTS `#__umart_tag_items`
(
...
-- ----------------------------
-- Table structure for `#__umart_translations`
-- ----------------------------

CREATE TABLE IF NOT EXISTS `#__umart_translations`
(
...
--
-- Table structure for table `#__umart_order_field_price_xref`
--

CREATE TABLE IF NOT EXISTS `#__umart_order_field_price_xref`
(
