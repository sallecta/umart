...
<div class="uk-card uk-card-default uk-card-small uk-card-body">
	...
	<?php if ($params->get('sub_total', 1)): ?>
        <div class="uk-grid-small" uk-grid>
            <div class="uk-width-expand"
                 uk-leader="fill: ."><?php echo Text::_('COM_UMART_SUBTOTAL'); ?></div>
	...
	<?php if ($params->get('taxes', 1) && $data['totalTaxes'] > 0.00): ?>
        <div class="uk-grid-small" uk-grid>
            <div class="uk-width-expand" uk-leader="fill: ."><?php echo Text::_('COM_UMART_TAXES'); ?></div>
	...
	<?php if ($params->get('shipping', 1) && $data['totalShip'] > 0.00): ?>
        <div class="uk-grid-small" uk-grid>
            <div class="uk-width-expand" uk-leader="fill: ."><?php echo Text::_('COM_UMART_SHIPPING'); ?></div>
	...
	<?php if ($params->get('payment_fee', 1) && $data['paymentFee'] > 0.00): ?>
        <div class="uk-grid-small" uk-grid>
            <div class="uk-width-expand" uk-leader="fill: ."><?php echo Text::_('COM_UMART_PAYMENT_FEE'); ?></div>
	...
	<?php if ($params->get('discount', 1) && $data['orderDiscount'] > 0.00): ?>
        <div class="uk-grid-small" uk-grid>
            <div class="uk-width-expand"
                 uk-leader="fill: ."><?php echo Text::_('COM_UMART_ORDER_DISCOUNT'); ?></div>
	...
	<?php if ($params->get('grand_total', 1)): ?>
        <div class="uk-grid-small" uk-grid>
            <div class="uk-width-expand" uk-leader="fill: ."><?php echo Text::_('COM_UMART_GRAND_TOTAL'); ?></div>
